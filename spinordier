...
credits:CreateText({
    name = "Credits",
    text = "By IceyWWW, Join the Discord server if you find any bugs, made with ❤️",
})

credits:CreateText({
  name = "Discord Server",
  text = "https://discord.gg/B5qyFzPgmT Go to Robloxscripts if you don't wanna type it."
})
